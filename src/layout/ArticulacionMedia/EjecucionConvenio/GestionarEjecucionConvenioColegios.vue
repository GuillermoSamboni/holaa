    ...
    <div class="card">
      <div class="card-header">
        <h1 class="text-azul-sena">
          <h1 class="text-azul-sena">LISTA DE COLEGIOS</h1>
        </h1>
      </div>
      <div class="card-body">
              ...
              <table class="table table-hoverble">
                ...
                <tbody>
                  <template
                    ...
                    "
                  > 
                  <tr v-for="(colegio, key) in filtrar('listaColegiosFiltrado')" :key="key">
                    <tr
...
<script lang="ts">
  ...
  export default class GestionarEjecucionColegio extends Vue {
    listaColegios = [];
