  ...
  <div class="mt-4 container-fluid">
    <div class="card">
      <div class="card-header">
        <h1 class="text-azul-sena">MODIFICAR CONVENIO</h1>
        <hr />
        <!-- Contenido -->
        <div>
          <div class="card-body">
            <div class="col-lg-8 col-md-10 col-sm-12 offset-lg-2 offset-md-1">
              ...
              <div v-if="convenio.municipio_id != ''">
                ...
                >
                  <!-- v-validate="{ required: true }" -->
                  <option
                    :value="convenio.centro_formacion_id"
                    selected
                    disabled
                  >
                    {{ convenio.centro_formacion }}
                  </option>
                  <option
              ...
              <!-- <div id="multiselect">
                ...
                <template>
                  <div>
                    <multiselect
                      v-model="colegioEscogidocolegioEscogido"
                      tag-placeholder="seleccione el colegio"
