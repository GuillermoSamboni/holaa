<template>
  <div class="mt-4 container-fluid">
    <div class="card">
      <h1 class="text-azul-sena">Lista Reportes Pane Regional</h1>
          ...
          <table class="table table-hoverble">
            ...
            <tbody>
              <template v-if="listarLineamientosFiltrado != null">
                ...
                ><td v-if="lineamiento.regional_id == usuario.regional">
                </td>
                  <td>
