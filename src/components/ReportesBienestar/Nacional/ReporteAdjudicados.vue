  ...
  <div class="mt-4">
    <div class="card">
      <div class="card-header">
        <h1 class="text-azul-sena">REPORTES ADJUDICADOS NACIONAL</h1>
      </div>
          ...
          <div class="row">
            <div class="col-lg-2 col-sm-12 mr-4">
              ...
              <div class="mt-2">
                <select class="form-control" id="sector" name="sector">
                  ...
                  <option
                    v-for="(año, key) in año"
                    :key="key"
                    v-bind:value="año.id_regional"
                  >
                    {{ año.año }}
                  </option>
                </select>
              ...
              <div class="mt-2 mb-2">
                ...
                >
                  ...
                  <option value="">Todas</option>
                  <option
                    v-for="(fase, key) in AdjudicadosFiltrado"
                    :key="key"
            ...
            <div class="col-lg-9 col-md-12 col-sm-12">
              ...
              <div class="table-responsive">
                <paginate
                  ref="paginator"
                  name="AdjudicadosFiltrado"
                  :list="AdjudicadosFiltrado"
                  :per="10"
                >
                  <table class="table table-hoverble">
                    ...
                    <tbody>
                      <template v-if="AdjudicadosFiltrado != null">
                        <tr
                          v-for="(proceso, index) in paginated(
                            'AdjudicadosFiltrado'
                          )"
                          :key="index"
                        >
