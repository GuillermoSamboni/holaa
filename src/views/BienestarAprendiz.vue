...
import QuienesSomos from './componentes-b-a/QuienesSomos.vue';
import Funciones from './componentes-b-a/Funciones.vue';
import EstructuraOrganizacional from './componentes-b-a/EstructuraOrganizacional.vue';
import Directorio from './componentes-b-a/Directorio.vue';
import Noticias from './componentes-b-a/Noticias.vue';
import Planeacion from './componentes-b-a/Planeacion.vue';
import Video from './componentes-b-a/Video.vue';
