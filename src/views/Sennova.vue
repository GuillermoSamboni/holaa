...
import QuienesSomos from './componentes-sennova/QuienesSomos.vue';
import Funciones from './componentes-sennova/Funciones.vue';
import EstructuraOrganizacional from './componentes-sennova/EstructuraOrganizacional.vue';
import Directorio from './componentes-sennova/Directorio.vue';
import Noticias from './componentes-sennova/Noticias.vue';
import Planeacion from './componentes-sennova/Planeacion.vue';
import Video from './componentes-sennova/Video.vue';
...
export default class BienestarAprendiz extends Vue{
  contenidoSection = 0;
