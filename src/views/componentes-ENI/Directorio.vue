    ...
    <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="d-flex  justify-content-between mb-5 flex-wrap">
                <h3 class="blod text-azul-sena text-capitalize titulo m-0">Directorio</h3>
            </div>
                ...
                <table class="table">
                    <thead >
                        <tr>
                            ...
                            <th scope="col">IP</th>
                            <th scope="col">E-mail Sena</th>
                            <th scope="col">Rol</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="item in lista" :key="item.idn" class="mt-2">
                            <td>{{item.nombre}}</td>
                            <td>{{item.telefono}}</td>
                            <td>{{item.ip}}</td>
                            <td>{{item.e_mail}}</td>
            ...
            <a class="btn bg-azul-sena mt-2 text-white col-12 col-md-3" href="../../assets/descargas/directorio2020.pdf" download>Descargar</a>
            <!--<div>
                 <img class="col-5" src="../../assets/bienestar/directorio.svg" alt="">
            </div>-->
        </div>
    </div>
</template>
