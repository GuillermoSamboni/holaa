...
import QuienesSomos from './componentes-e-f/QuienesSomos.vue';
import Funciones from './componentes-e-f/Funciones.vue';
import EstructuraOrganizacional from './componentes-e-f/EstructuraOrganizacional.vue';
import Directorio from './componentes-e-f/Directorio.vue';
import Noticias from './componentes-e-f/Noticias.vue';
import Planeacion from './componentes-e-f/Planeacion.vue';
import Video from './componentes-e-f/Video.vue';
