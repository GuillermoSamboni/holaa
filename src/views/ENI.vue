...
import QuienesSomos from './componentes-ENI/QuienesSomos.vue';
import Funciones from './componentes-ENI/Funciones.vue';
import EstructuraOrganizacional from './componentes-ENI/EstructuraOrganizacional.vue';
import Directorio from './componentes-ENI/Directorio.vue';
import Noticias from './componentes-ENI/Noticias.vue';
import Planeacion from './componentes-ENI/Planeacion.vue';
import Video from './componentes-ENI/Video.vue';
